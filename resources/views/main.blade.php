...
<div class="slider1 flexslider">  <!-- Slider -->
	<ul class="slides">
		<li>
			<img src="{{asset('public/img/slider/1.jpg')}}" alt="">
		</li>
		<li>
			<img src="{{asset('public/img/slider/2.jpg')}}" alt="">
		</li>
		<li>
			<img src="{{asset('public/img/slider/3.jpg')}}" alt="">
		</li>
		<li>
			<img src="{{asset('public/img/slider/4.jpg')}}" alt="">
		</li>
	</ul>
</div>  <!-- Slider End -->
@endsection
